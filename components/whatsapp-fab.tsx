...
export default function WhatsAppFab() {
  return (
    <Link
      ...
      className="fixed right-4 bottom-4 z-[60] h-14 w-14 rounded-full flex items-center justify-center shadow-[0_0_14px_rgba(37,211,102,0.6)] hover:shadow-[0_0_24px_rgba(37,211,102,0.85)] transition-shadow"
      style={{ backgroundColor: "#25D366" }}
    >
      {/* Original-style WhatsApp glyph (white) */}
